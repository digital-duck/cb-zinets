  ...
  main.innerHTML = `
    ...
    <ul>
      <li>
        ...
        <strong>English (EN)</strong> and <strong>Chinese (ZH)</strong> using
    ...
    <ul>
      <li>
        <a href="https://github.com/digital-duck/cb-zinets" target="_blank" rel="noopener">digital-duck/cb-zinets</a>
        — this app (the Chinese characters use-case)
      </li>
      <li>
        <a href="https://github.com/digital-duck/concept-book" target="_blank" rel="noopener">digital-duck/concept-book</a>
