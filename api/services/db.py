...
def init_db(db_path: Path = DB_PATH) -> None:
    ...
    _ensure_column(con, "cb_users", "oauth_provider", "TEXT")
    _ensure_column(con, "cb_users", "oauth_id", "TEXT")
    _ensure_column(con, "cb_users", "display_name", "TEXT")
    _ensure_column(con, "cb_users", "avatar_url", "TEXT")
    _seed_admin(con)
    con.commit()
    con.close()
