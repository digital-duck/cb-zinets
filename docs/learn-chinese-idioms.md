...
**Worked specimen — 狼心狗肺, the strongest insult in the menagerie.** What makes it the extreme case is *anatomical essentialism*. Most animal idioms attack behavior — 对牛弹琴's audience merely *acts* dumb, 胆小如鼠's coward merely *behaves* timidly, and behavior can change. 狼心狗肺 claims your 心 and 肺 — the vital core, the organs of feeling and of breath — *are* a predator's and a scavenger's. It attacks substance, not conduct; English "cold-hearted" is its pale cousin. The two despised-tier animals divide the labor — the wolf donates cruelty to the heart, the dog donates baseness to the lungs — a composite insult assembled like a composite character. Structurally it is a perfect 2+2 对仗 (狼**心** ‖ 狗**肺**: animal+organ, animal+organ), so it is also where this sentiment section and the 偈-parallelism section above shake hands. And it is a cross-category bridge — Animals × Body — which makes it graph-gold: in cb_zinets it links the 狼/狗 cluster to the 心/肺 cluster, a built-in Season B ↔ Season C crossover shot. Its usage niche is precise, too: it is the idiom of *betrayed kindness* (救了他，他却狼心狗肺 — "saved his life, and he repaid it with a wolf's heart and a dog's lungs"), the vivid twin of the abstract 忘恩负义.
